...
class WaypointUpdater(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            #rospy.loginfo('Waypoint Updater - closest_waypoint_idx: %s', closest_waypoint_idx)
    ...
    def generate_lane(self):
        ...
        rospy.loginfo("Incoming red light idx: %s", self.stopline_wp_idx) 
    ...
    def decelerate_waypoints(self, base_waypoints, closest_idx):
        ...
        for i, wp in enumerate(base_waypoints):
            ...
            vel = math.sqrt(2 * MAX_DECEL * dist) # velocity decreases as dist decreases
